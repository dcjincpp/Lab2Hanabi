...
def useless(board):
    def useless_inner(card):
        return card.is_useless(board) #check if card is useless
...
#check each color with potential hand and if there is more than 0 of that color, add card to the result
